...
export const Ios = (props: Props) => {
  return (
    ...
    >
      <h1 className='section-title flex justify-center font-GEO703 text-4.5xl lg:text-3xl'>
        CS50xShirazU
      </h1>
      ...
      <h1 className='section-title flex justify-center font-extrabold text-3xl'>
      ...
      <section
        id='team'
        className='w-full p-page mt-12 flex flex-col gap-20 '
      >
        <h1 className='section-title flex justify-center font-extrabold text-3xl text-nowrap'>
          تیم ما
        </h1>
        <Slider
          isTeam={false}
