...
import HeaderBackgroundImage from "@/assets/images/team-header.jpg";

const Header = () => {
    return (
        <div className="w-full h-[calc(100vh-140px)] relative">
            <Image src={HeaderBackgroundImage} className="object-cover brightness-[60%]" fill alt="header-background" />
