...
const VideoSection = () => {
    ...
    return (
        <div className="aspect-video h-full flex-1 relative bg-black flex justify-center items-center">
            {/*{!removePoster && (*/}
            {/*    <div*/}
            ...
            {/*                <Image src={SymbolImage} alt="symbol"*/}
            {/*                       className="max-xs:size-[30px] max-xl:size-[40px] rotate-90" />*/}
            ...
            {/*                    <svg className="size-[45px] xs:size-[55px] xl:size-[70px]" viewBox="0 0 69 69"*/}
            {/*                         fill="none"*/}
            ...
            {/*            <div className="z-20 w-full flex justify-between">*/}
            {/*                <Image src={SymbolImage} alt="symbol"*/}
            {/*                       className="max-xs:size-[30px] max-xl:size-[40px] rotate-180" />*/}
            {/*                <Image src={SymbolImage} alt="symbol"*/}
            {/*                       className="max-xs:size-[30px] max-xl:size-[40px] -rotate-90" />*/}
            {/*            </div>*/}
            {/*        </div>*/}
